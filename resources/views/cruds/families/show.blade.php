            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade in active" id="general">
                ...
                <div class="form-group {{{ $errors->has('first_name') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('first_name', $family->first_name, array('class' => 'form-control'  , 'size' => '64', 'maxlength' => '64'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('last_name') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('last_name', $family->last_name, array('class' => 'form-control'  , 'size' => '64', 'maxlength' => '64'  )) !!}
              ...
              <div class="tab-pane fade " id="personal">
                ...
                <div class="form-group {{{ $errors->has('date_of_birth') ? 'has-error' : '' }}}">
                    ...
                    <div class="input-group col-md-4 date date_of_birth">
                      {!! Form::text('date_of_birth', $family->date_of_birth, array('class' => 'form-control', 'size' => '16'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('nacionality') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('nacionality', $family->nacionality, array('class' => 'form-control'  , 'size' => '64', 'maxlength' => '64'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('city_of_birth') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('city_of_birth', $family->city_of_birth, array('class' => 'form-control'  , 'size' => '64', 'maxlength' => '64'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('marital_status') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('marital_status', $family->marital_status, array('class' => 'form-control'  , 'size' => '3', 'maxlength' => '3'  )) !!}
              ...
              <div class="tab-pane fade " id="identifications">
                ...
                <div class="form-group {{{ $errors->has('document_type') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('document_type', $family->document_type, array('class' => 'form-control'  , 'size' => '3', 'maxlength' => '3'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('document_number') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('document_number', $family->document_number, array('class' => 'form-control'  , 'size' => '20', 'maxlength' => '20'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('passport_number') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('passport_number', $family->passport_number, array('class' => 'form-control'  , 'size' => '20', 'maxlength' => '20'  )) !!}
                ...
                <div class="form-group {{{ $errors->has('ss_number') ? 'has-error' : '' }}}">
                    ...
                    <div class="controls">
                    {!! Form::text('ss_number', $family->ss_number, array('class' => 'form-control'  , 'size' => '20', 'maxlength' => '20'  )) !!}
