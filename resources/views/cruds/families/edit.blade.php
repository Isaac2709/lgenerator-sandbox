						...
						<div class="panel-body">  
							<div class="row">
								<div class="{{$lc->config('col_full')}}">
									{!! Form::model($family, array('method' => 'PATCH', 'route' => array('families.update', $family->id))) !!}	
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade " id="identifications">
                ...
                <!-- /ss_number -->
										...
										{!! link_to_route($routeBtnShow, trans('forms.Cancel'), $lc->editArgs($family->id), array('class' => 'btn btn-default '.$classBtnShow)) !!}
										</div>
										<!-- /buttons -->
										<p class="divider"></p>
									{!! Form::close() !!}
